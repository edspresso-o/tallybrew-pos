...
export default function Inventory({ ingredients, onRestockClick, onAddIngredientClick, onWastageClick }) {
  return (
    <div style={{ padding: '30px 40px', flex: 1, overflowY: 'auto', backgroundColor: '#fff' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px' }}>
        ...
        <div style={{ display: 'flex', gap: '12px' }}>
          <button 
            ...
            style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '10px 16px', borderRadius: '8px', border: '1px solid #ef4444', background: '#fff', color: '#ef4444', fontWeight: '600', cursor: 'pointer', fontSize: '14px', transition: '0.2s' }}
          ...
          <button 
            ...
            style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '10px 20px', borderRadius: '8px', border: 'none', background: '#b85e2b', color: '#fff', fontWeight: '600', cursor: 'pointer', fontSize: '14px', transition: '0.2s' }}
          ...
          <button 
            ...
            style={{ padding: '10px 16px', borderRadius: '8px', border: '1px solid #e5e7eb', background: '#f9fafb', color: '#374151', fontWeight: '600', cursor: 'pointer', fontSize: '14px', transition: '0.2s' }}
      ...
      {/* THE TABLE DESIGN */}
      <div style={{ background: '#fff', borderRadius: '16px', border: '1px solid #f3f4f6', boxShadow: '0 4px 12px rgba(0,0,0,0.02)', padding: '10px 20px' }}>
              ...
              ingredients.map((item, index) => {
                ...
                return (
                  <tr key={item.id} style={{ borderBottom: '1px solid #f9fafb' }}>
                    ...
                    <td style={{ padding: '20px 10px' }}>
                      {isLow ? (
                        <div style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', background: '#fef2f2', color: '#ef4444', padding: '6px 10px', borderRadius: '20px', fontSize: '10px', fontWeight: '800', letterSpacing: '0.5px' }}>
                        ...
                        <div style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', background: '#ecfdf5', color: '#10b981', padding: '6px 10px', borderRadius: '20px', fontSize: '10px', fontWeight: '800', letterSpacing: '0.5px' }}>
